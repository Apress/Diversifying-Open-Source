...
The repository translates the book's conceptual framework into a blueprint to help you understand concepts and to implement them copy/ pasting it or using the cli to help you create the documents on your own repo.
...
This repository operationalizes this argument.
...
- embed restorative instead of punitive conflict handling,
- document funding, adoption and influence,
...
- [**Procedural**](templates/Procedural/README.md)
- [**Long-Term**](templates/Long-Term/README.md)
...
- generate personalized documents from templates using a wizzard,
...
The `.github/` folder contains **platform-specific configuration** that supports this standard application and maintenance.
...
Such files are example about how automation can take a lot of the workload.
