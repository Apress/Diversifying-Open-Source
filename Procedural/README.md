...
This directory contains procedural and process documentation for the project.
...
- **[decision-log.md](decision-log.md)** - Decision tracking and logging
- **[role-rotation.md](role-rotation.md)** - Role rotation procedures
- **[audit-checklist.md](audit-checklist.md)** - Audit checklist
...
- [ ] Processes reduce day-to-day friction
- [ ] Updates are intentional and traceable
