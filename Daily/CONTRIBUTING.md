...
1. Check open issues with labels like:
   - `good-first-issue`
   - `help-wanted`
   - `needs-review`
   - `needs-docs`
   - `needs-a11y`
2. Comment on the issue to signal interest.
3. Ask questions early — clarification is encouraged.
...
- If your contribution is non-code, say so explicitly.
